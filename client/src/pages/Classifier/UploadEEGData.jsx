...
import LoadingSpinner from "../../components/UI/AnalyzingSpiiner";
              ...
              <div className="relative flex items-center justify-between">
                ...
                <div>
                  ...
                  <div className="mt-2 flex items-center gap-3">
                    <span className="px-4 py-1.5 rounded-full bg-emerald-100 dark:bg-emerald-800/40 text-emerald-800 dark:text-emerald-200 text-xl uppercase font-bold tracking-wide shadow-sm">
                      {prediction.region}
                    </span>
